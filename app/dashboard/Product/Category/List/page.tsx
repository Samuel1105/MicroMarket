        ...
        <ProtectedRoute allowedRoles={[1, 3]}>
            ...
            <div className="p-4 md:p-8">
                <div className="flex justify-end items-center mb-6">
                    <Button onPress={() => router.push('/Dashboard/Product/Category/New')} color="primary">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {items && items.length > 0 ? (
                        <CategoryCard categories={items} onDeleteSuccess={handleDeleteSuccess} />
                    ) : (
                        <div className="col-span-full text-center py-10">
                            <h1 className="text-xl text-default-500">No hay categorías disponibles</h1>
                        </div>
                    )}
                </div>
