...
export default function CardMobileCustomer({ items, handleDeleteSuccess }: { items: CustomerList, handleDeleteSuccess: () => void }) {
    return (
        <>
            {items.map((item) => (
                <Card key={item.id} className="w-full">
                    <CardBody className="p-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                <Icon icon="heroicons:identification" width="16" height="16" className="text-gray-500" />
