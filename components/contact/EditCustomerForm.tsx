...
import { CustomerUpdate, CustomerUpdateSchema } from "@/src/schema/SchemaContact";
...
export default function EditCustomerForm({ children }: { children: React.ReactNode }) {
        ...
        <div className="bg-white px-8 py-10 rounded-lg shadow-large w-full">
            ...
            <Form className="w-full" onSubmit={handleSubmit}>
                ...
                <div className="mt-5 w-full space-x-5">
                    ...
                    <Button color="danger" className="mt-4" onPress={() => router.push('/Dashboard/Contact/Customer/List')}>
                        Cancelar
                    </Button>
                </div>
            </Form>
